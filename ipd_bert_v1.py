...
for fold in np.arange(n_fold):
    ...
    for ep in np.arange(n_epochs):
        ...
        for bc in np.arange(train_set.shape[0] / batch_size):
            ...
            pred = output.squeeze()[:, :-lag, 0]  # Predictions for positions 4-8 (5 elements)
            targ = target[:, lag:, 0]            # Targets for positions 4-8 (5 elements)
        ...
        with torch.no_grad():
            ...
            val_pred = val_output.squeeze()[:, :-lag, 0]  # Predictions for positions 4-8
            val_targ = val_inputs[:, lag:, 0]            # Targets for positions 4-8
...
plt.savefig(
    "Figures/IPD_v1/ipd_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.plot(pred_positions, robust_MSE_by_time(ry[:, lag:], py_bert[:, :-lag, 0]), "b", label="BERT")
...
plt.tight_layout()
plt.savefig(
    "Figures/IPD_v1/ipd_mse_comparison_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("Cooperation Rates")
plt.savefig(
    "Figures/IPD_v1/ipd_lstm_vs_bert_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("loss")
plt.savefig(
    "Figures/IPD_v1/ipd_lstm_loss_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("loss")
plt.savefig(
    "Figures/IPD_v1/ipd_bert_loss_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.legend()
plt.savefig(
    "Figures/IPD_v1/ipd_bert_val_loss_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("Cooperation Rates")
plt.savefig(
    "Figures/IPD_v1/ipd_lstm_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("Cooperation Rates")
plt.savefig(
    "Figures/IPD_v1/ipd_bert_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("Cooperation Rates")
plt.savefig(
    "Figures/IPD    /ipd_ar_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
...
plt.ylabel("Cooperation Rates")
plt.savefig(
    "Figures/IPD_v1/ipd_lr_coop_nodes_" + str(n_nodes) + "_layers_" + str(n_layers) + ".png"
)
